...
<div class="container mt-4">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <p class="text-muted">Selamat datang di <b>Maldin17</b>App! Berikut adalah ringkasan sistem hari ini.</p>
            <hr>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 mb-4">
            <div class="card shadow-sm border-0">
                                    ...
                                    <?php foreach ($permintaanTerbaru as $p) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('/peminjaman/detail/' . $p['id']) ?>" class="btn btn-sm btn-primary rounded-pill px-3">Detail</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                ...
                <div class="card-footer bg-white text-center border-0 py-3">
                    <a href="<?= base_url('/peminjaman') ?>" class="text-decoration-none small fw-bold text-primary">LIHAT SEMUA TRANSAKSI <i class="bi bi-chevron-right ms-1"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card shadow-sm border-0 text-white bg-dark">
                <div class="card-body">
                    <h6 class="fw-bold mb-3"><i class="bi bi-info-circle me-2 text-info"></i>Kondisi Alat</h6>
                    <ul class="list-unstyled mb-0 small">
                        <li class="mb-2 d-flex align-items-center">
                            <i class="bi bi-tools text-warning me-2 fs-5"></i>
                            <span>3 Alat butuh servis rutin</span>
                        </li>
                        <li class="d-flex align-items-center">
                            <i class="bi bi-box-arrow-in-down text-info me-2 fs-5"></i>
                            <span>5 Alat baru tiba bulan ini</span>
                        </li>
                    </ul>
                </div>
            </div>
